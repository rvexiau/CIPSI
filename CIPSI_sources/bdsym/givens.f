...
c
      ...
      dimension h(ndetz*(ndetz+1)/2),e(ndetz),v(ndetz*ndetz)
      dimension b(ndetz),c(ndetz),p(ndetz),q(ndetz),
...
c
      write(6,*) 'GIVEN GIVEN ',n,nev,nvec
 ...
 3470 continue
  ...
  999 return
   95 write(6,102)i,ii,joym
      call exit
  100 format('givens 100: ',1h0,10i5)
  101 format('givens 101: ',1h0,i4,e16.8,i3,3e18.8)
  102 format('givens 102: ',1h0,i4,i3)
      return
 99   continue
      e(1)=h(1)
      v(1)=1.0
