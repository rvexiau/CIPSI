      ...
      dimension fmul(metz),tabsym(10),venvp(metz)                                   
...
3     nps(ls)=part(nposte+ls)             
      call pie(necst,nts,nps,1.d0,venvp,metat)                                      
4     continue                                                          
      call fine(metat)                                                         
5     continue                                                          
      if(ityper.lt.0) stop
      ...
      if(ymoyen) call fine(metat)
      write(*,'(a37)') 'nombre de determinants sur la file 60'
      write(*,'(2i12)') ntot,metat
      write(6,1225) ietat                                               
...
2000  format(1x,32('*'))                                                
      ...
      if(.not.yen) then                                                 
      write(6,1070)                                                     
1070  format(1x,'etat      ',6x,'  diag',6x,' pertu mpb')           
      else                                                              
      write(6,1065)                                                     
1065  format(1x,'etat      ',6x,'  diag',6x,' pertu mpb',           
     * 6x,' pertu envp',6x,' pertu enb')                                
      endif                                                             
      do 10 m=1,metat                                                                                              
      if(.not.yen) then                                                 
      write(6,1086) numero(m),e(m),e2mp(m)                     
1086  format(2x,i2,4x,4(2x,f14.8))                                
      else                                                              
      write(6,1086) numero(m),e(m),e2mp(m),e2vp(m),e2b(m)      
      endif                                                             
  10  continue                                                          
      write(6,1030)                                                     
      write(6,1030)                                                     
      if(.not.yen) then                                                 
      write(6,1110)                                                     
1110  format(1x,'etat      ',4x,' scf+diag',6x,'total mpb')         
      else                                                              
1115  write(6,1120)                                                     
1120  format(1x,'etat      ',4x,' scf+diag',6x,'total mpb',         
     * 7x,'total envp',6x,'total enb')                                  
      ...
      hefb(mm)=e(m)+e2b(m)                                              
      if(.not.yen) then                                                 
      write(6,1086) numero(m),e(m),hefmp(mm)                   
      else                                                              
      write(6,1086) numero(m),e(m),hefmp(mm),                  
     1 hefvp(mm),hefb(mm)                                               
      endif                                                             
...
1540  format(12x,'inf:',10(2x,e9.2))                                    
      write(6,1550) (aval(ii),ii=1,nclass)                              
1550  format(12x,'sup:',10(2x,e9.2))                                    
      write(6,1030)                                                     
      write(6,1030)                                                     
