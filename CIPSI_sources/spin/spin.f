      ...
      character*8 group        
      dimension fmul(metz),c(metz*ndetz),e(ndetz)
...
37       format(i3,9x,i3,7x,f20.12)
      ...
      write(6,*) 'real values'
      do i=1,nvr
        write(6,38) i,2.*sol(i)+1.,e(i)
38      format(i3,9x,f12.5,7x,f20.12)
      enddo
     ...
     *     .and.n1.eq.2)) then
      ...
      case (1)
        ...
        if(dnorme.ge.dnormes) qgood=.false.
      case (2,3)
        dnorme=dnormes+dnormed+dnormef
        if(dnorme.ge.dnormep) qgood=.false.      
      case (4,5)
        dnorme=dnormes+dnormep+dnormef
        if(dnorme.ge.dnormed) qgood=.false.      
      case (6,7)
        dnorme=dnormes+dnormep+dnormed
        if(dnorme.ge.dnormef) qgood=.false.      
      end select
