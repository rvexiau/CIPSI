...
c     lecture de la file 40
      ...
      read(40)ninte,(ntttt(i),i=1,nsym)
      write(6,*)' nombre d''integrales lues sur f40', ninte
      if(ninte.gt.kget)then
	write(6,*)'le nombre d''integrales',ninte,' est superieur a la'
