      ...
      include 'pshf.prm' 
      logical*1 iandj,out,norm,double,ycv
...
c                                                                       
     ...
     3         11,11, 6, 6,11/                                          
      ...
      nprint=0
      out=(nprint.eq.1).or.(nprint.eq.3)                                
      itpmax=3                                                          
...
c                                                                       
      ...
      ys(jn)=sy(nn)                                                     
      zs(jn)=sz(nn)                                                     
c      print *,'xyzsm',xs(jn),ys(jn),zs(jn)
 7500 continue                                                          
 8000 continue                                                          
 9000 continue                                                          
c      write(6,*) 'point 9', 'ycv ',ycv
c----------------------------------------------------------
c
c     correction electronique (coeur valence)
c
      if (.not.ycv) go to 950
      naa=num*(num+1)/2
c      print *,'naa',naa,' num',num
      rewind 17
      do 830 ic=1,nat
      alfad=calfa(ic)
      print *,'alfad',alfad
      if (dabs(alfad).lt.1.0d-06) go to 825
...
c
      do 820 l=1,naa
      xs(l)=xs(l)-alfad*epol(l,1)
      ys(l)=ys(l)-alfad*epol(l,2)
      zs(l)=zs(l)-alfad*epol(l,3)
c      print *,'epol',epol(l,1),epol(l,2),epol(l,3)
c      print *,'xyzs   ',xs(l)+alfad*epol(l,1),ys(l)+alfad*epol(l,2),
c     *                  zs(l)+alfad*epol(l,3)
c      print *,'xyzs cv',xs(l),ys(l),zs(l)
  820 continue
  825 continue
  830 continue
950   continue
